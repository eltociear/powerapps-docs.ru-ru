...
ms.locfileid: "2705990"
---
# <a name="change-the-solution-publisher-prefix"></a>Изменение префикса издателя решения

Каждая настройка является частью решения. Каждое решение имеет издателя. По умолчанию решение, с которым вы будете работать в PowerApps, будет **Решение по умолчанию служб Common Data Service**, связанное с параметром **Издатель Common Data Service по умолчанию**.
