...
В Common Data Service уже настроено несколько стандартных ролей подключения. Для их просмотра необходимо перейти в область параметров. 
...
[Создание и изменение глобального набора параметров для Common Data Service (списки выбора)](create-edit-global-option-sets.md)<br />
