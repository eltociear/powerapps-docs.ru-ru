...
description: 'Введение в Common Data Service, сущности и логику на стороне сервера.'
author: clwesene
manager: kfile
...
В дополнение к функциям, доступным через портал [PowerApps](https://web.powerapps.com/?utm_source=padocs&utm_medium=linkinadoc&utm_campaign=referralsfromdoc), Common Data Service также включает функции для разработчиков для программного доступа к метаданным и данным для создания сущностей и бизнес-логики, а также для взаимодействия с данными. Чтобы получить дополнительные сведения, см. раздел [Обзор для разработчиков Common Data Service](../../developer/common-data-service/overview.md)
