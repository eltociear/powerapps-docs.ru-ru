...
В таблице перечислено ограниченные сущности и связанные требования лицензирования Dynamics 365 для пользователей приложений PowerApps и Microsoft Flow, которые создают, обновляют или удаляют данные, хранящиеся в сущностях. 
