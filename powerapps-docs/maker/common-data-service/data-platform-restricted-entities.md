...
Если приложение или поток только считывают данные из сущности, лицензия на Dynamics 365 не требуется, и соответствующая лицензия на Power Apps или Power Automate — это все, что требуется. 
...
В таблице перечислено ограниченные сущности и связанные требования лицензирования Dynamics 365 для пользователей приложений Power Apps и Power Automate, которые создают, обновляют или удаляют данные, хранящиеся в сущностях. 
...
Дополнительные сведения о лицензиях Power Apps и Dynamics 365 см. на странице [Обзор лицензирования](../../administrator/pricing-billing-skus.md).
