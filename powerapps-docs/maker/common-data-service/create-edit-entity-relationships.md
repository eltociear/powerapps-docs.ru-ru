...
> - Если исходная родительская запись и запрошенное действие содержат одинаковые значения. Пример. Попытка активировать назначение и выбор контакта, который уже является владельцем записи
> - Попытка выполнить действие с родительской записью, которая уже выполняет каскадное действие

> [!NOTE]
> При выполнении назначения любые рабочие процессы или бизнес-правила, которые в данный момент активны в записях, будут автоматически деактивированы при переназначении. Новому владельцу записи потребуется повторно активировать рабочий процесс или бизнес-правило, если они хотят продолжить его использование.
