---
title: Импорт или экспорт данных из Common Data Service
description: Групповой импорт и экспорт данных из файлов Excel или CSV в сущности в Common Data Service с помощью функций получения данных из Excel и экспорта данных
author: sabinn-msft
...
ms.locfileid: "2755590"
---
# <a name="import-or-export-data-from-common-data-service"></a>Импорт или экспорт данных из Common Data Service

Для группового импорта и экспорта данных из файлов Microsoft Excel или CSV используйте функции получения данных из файла Excel и экспорта данных для обновленных сред Common Data Service.
...
1. Импортируйте файл.  
    a. На сайта [powerapps.com](https://make.powerapps.com/) разверните раздел **Данные**. В левой области переходов выберите **Сущности**.  
...
Если вы опытный пользователь и знаете требуемые поля для определенной сущности для сущностей Common Data Service, определите собственный исходный файл Excel или CSV. Следуйте инструкциям в разделе **Импорт файла**.
...
Пример:  
Для сущности **Организация** можно установить **transactioncurrencyid** в качестве альтернативного ключ с помощью естественной идентификации на основе ключей. Например, используйте **Доллар США** вместо значения идентификатора GUID **88c6c893-5b45-e811-a953-000d3a33bcb9**, отображаемого ранее. Можно также выбрать как ключи **символ валюты** или **название валюты**.
...
1. На сайта [powerapps.com](https://make.powerapps.com/) разверните раздел **Данные**. В левой области переходов выберите **Сущности**.
