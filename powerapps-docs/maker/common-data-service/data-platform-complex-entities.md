---
title: Сложные сущности, требующие лицензии Power Apps плана 2 | Документация Майкрософт
description: Список сложных сущностей в Common Data Service, которым требуется лицензия Power Apps плана 2.
...
* Подключаемые модули кода. Дополнительные сведения: [Разработка подключаемых модулей](/powerapps/developer/common-data-service/plug-ins)
* Бизнес-процессы реального времени. Дополнительные сведения: [Бизнес-процессы](/flow/workflow-processes)
...
## <a name="complex-entities-installed-with-dynamics-365-apps"></a>Сложные сущности, устанавливаемые с приложениями Dynamics 365
В следующей таблице перечислены сущности содержат сложную серверную логику из коробки, как часть установки приложений на основе модели в Dynamics 365, таких как Dynamics 365 Sales и Dynamics 365 Customer Service. Этот список предназначен в качестве руководства. В зависимости от приложений и версий Dynamics 365, установленных в вашей среде, список сложных сущностей может отличаться.
...
Дополнительные сведения о лицензиях Power Apps и Dynamics 365 см. страницу [Обзор лицензирования](../../administrator/pricing-billing-skus.md).
