...
Эта ошибка появляется, если Power Query не удается получить доступ к данным организации в Power Apps или Common Data Service. Эта ситуация возникает в двух наборах ситуаций:
