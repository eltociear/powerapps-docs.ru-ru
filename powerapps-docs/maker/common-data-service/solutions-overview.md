...
По умолчанию решение, с которым вы будете работать в Power Apps, будет **Решение по умолчанию служб Common Data Service**, связанное с параметром **Издатель Common Data Service по умолчанию**. Префикс настройки по умолчанию будет случайно назначен для этого издателя, например это может быть `cr8a3`. Это означает, что имя каждого нового элемента метаданных, созданных в организации, будет иметь этот префикс рядом с именами, используемыми для уникального определения элементов. 
