...
*Альтернативные ключи* обеспечивают эффективную и точную интеграцию данных с внешними системами. Это важно в случаях, когда внешняя система не хранит глобальные уникальные идентификаторы (GUID), которые уникально определяют записи в Common Data Service. 
