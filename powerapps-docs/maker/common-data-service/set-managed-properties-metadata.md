...
Для неуправляемых компонентов вы можете просматривать и изменять управляемые свойства. Для управляемых компонентов вы можете просматривать, но не изменять управляемые свойства. 
...
3.  Из списка компонентов в решении выберите **...** рядом с неуправляемой сущностью, для которой требуется просмотреть или изменить управляемые свойства, затем выберите **Управляемые свойства**. 
