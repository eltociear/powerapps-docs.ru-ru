...
> ![Изображение сущности по умолчанию](../common-data-service/media/account-record-default-image.png "Изображение сущности учетной записи по умолчанию")
...
7. В определении сущности рядом со свойством **Основное изображение** убедитесь, что в качестве значения указано пользовательское изображение, созданное на предыдущем шаге. Если это не так, выберите его.  
    ![Выбранное свойство основного изображения](media/primary-image-property.png)
...
10. На странице **Свойства формы** выберите вкладку **Показать**, выберите **Отображать изображение в форме**, затем выберите **ОК**. 
    ...
    > [!div class="mx-imgBorder"] 
    > ![Параметр отображать изображение в форме](media/show-image-on-form.png "Параметр отображать изображение в форме")
...
2. Выберите **Загрузить изображение**, просмотрите и выберите изображение, которое вы хотите отобразить в форме сущности, а затем выберите **Изменить**. Изображение появится на записи. 
   > [!div class="mx-imgBorder"] 
   > ![Измененное изображение сохранено в записи](../common-data-service/media/custom-entity-icon-record.png "Измененное изображение сохранено в записи")
