...
|**Ответственный**|Допускает одну ссылку на запись рабочей группы или запись пользователя. Все сущности, принадлежащие рабочим группам или пользователям, имеют одну из них. Дополнительные сведения: [Добавление сущности в качестве элемента подстановки в вашем приложении](../model-driven-apps/team-entity-lookup.md)|  
