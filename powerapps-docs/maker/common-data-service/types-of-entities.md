...
> [!NOTE]
> Нельзя создать настраиваемое действие с помощью портала Power Apps. Необходимо открыть обозреватель решений с помощью кнопки **Дополнительно**.
