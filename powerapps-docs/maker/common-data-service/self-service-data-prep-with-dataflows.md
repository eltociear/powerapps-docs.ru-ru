---
title: Самостоятельная подготовка данных с потоками данных в Power Apps | Документация Майкрософт
description: Узнайте, как использовать потоки данных в Power Apps для подготовки ваших данных
ms.custom: ''
ms.date: 08/05/2019
ms.reviewer: ''
...
-   **Common Data Service.** Позволяет безопасно хранить и управлять данными, которые используются бизнес-приложениями, созданными с использованием Power Apps и Power Automate.
...
Потоки данных могут использоваться для заполнения сущностей в [Common Data Service](https://docs.microsoft.com/powerapps/maker/common-data-service/data-platform-intro), которые затем используются в приложениях Power Apps. Несколькими щелчками мыши можно интегрировать данные из сетевых и локальных источников данных.
...
## <a name="summary-of-self-service-data-prep-for-big-data-in-power-apps"></a>Сводная информация о подготовке данных самообслуживания для больших данных в Power Apps
