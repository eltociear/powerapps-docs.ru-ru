...
## <a name="export-solutions"></a>Экспорт решений  
 Мы рекомендуем вам создать неуправляемое решение для экспорта настроек. Затем периодически экспортировать настройки, чтобы у вас была резервная копия на всякий случай. Экспортировать управляемые решения невозможно. Решения можно экспортировать из PowerApps или с помощью классического интерфейса. 
