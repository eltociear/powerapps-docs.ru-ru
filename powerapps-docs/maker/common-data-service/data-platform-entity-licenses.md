...
|Ограниченные сущности  |  Это сущности, которые не стандартны с Common Data Service, но включаются в приложения Dynamics 365 Customer Engagement или решения сторонних производителей. Например, статья базы знаний, цель и сущности объема обслуживания.     |  [План Dynamics 365](https://dynamics.microsoft.com/pricing/)      | 
