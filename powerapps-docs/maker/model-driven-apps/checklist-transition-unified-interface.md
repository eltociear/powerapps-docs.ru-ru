...
-   Используйте [PowerApps Component Framework](https://docs.microsoft.com/powerapps/developer/component-framework/overview) для добавления даже большего числа настраиваемых элементов управления. Можно получить некоторые от сообщества или от партнеров и независимых поставщиков программных продуктов.
