...
ms.locfileid: "3166809"
---
# <a name="understand-model-driven-app-views"></a>Общие сведения о представлениях управляемых моделью приложений

<a name="BKMK_CreatingAndEditingViews"></a>   

В приложениях Power Apps используйте представления для определения способа отображения списка записей для конкретной сущности в приложении. Представление определяет:
...
- Сайт Power Apps: чтобы получить доступ к конструктору представлений, выберите **Данные** > **Сущности**, выберите сущность, а затем выберите вкладку **Представление**. Откройте существующее представление или создайте новое. Дополнительные сведения: [Создание или изменение представления](create-and-edit-views.md).
