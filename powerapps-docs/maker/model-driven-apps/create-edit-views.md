...
- Сайт Power Apps: доступ к конструктору представлений можно получить, выбрав область **Управляемые моделью** > **Данные** > **Сущности** > вкладка **Представление**. Откройте существующее представление или создайте новое. Дополнительные сведения: [Создание или изменение представления](create-and-edit-views.md).
