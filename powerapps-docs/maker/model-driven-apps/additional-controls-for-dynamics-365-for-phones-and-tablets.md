...
>   
>  Видеозаписи YouTube в настоящее время не поддерживаются на планшетах и телефонах с Windows 8 и Windows 8.1. В Windows 10 поддерживаются только видеозаписи HTTPS (включая YouTube).  
