---
title: Предоставление возможности редактировать сетки (списки) управляемого моделью приложения с помощью настраиваемого элемента управления "Редактируемая сетка" в Power Apps | MicrosoftDocs
...
8.  Если вы хотите добавить события JavaScript, выберите вкладку **События** и выберите соответствующие сущности, поля и события. Дополнительные сведения: [Документация для разработчика. Использование допускающих изменения вложенных сеток](/dynamics365/customer-engagement/developer/customize-dev/use-editable-grids-dynamics-365.md)  
     ...
     ![Добавление событий в элементе управления "Редактируемая сетка"](media/add-events-in-editable-grid-control.png "Добавление событий в элементе управления "Редактируемая сетка"")  
