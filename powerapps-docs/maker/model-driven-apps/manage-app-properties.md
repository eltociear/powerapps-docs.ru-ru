...
2.  Измените сведения согласно требованиям:  
    ...
    |**Клиент<sup>1</sup>**|Определяет тип клиента, для которого будет использоваться приложение.<br/>-  **Веб.** Это классический клиент веб-браузера Dynamics 365 Customer Engagement.<br/>-  **Единый интерфейс.** Это новый клиент веб-браузера с аналогичным интерфейсом на компьютерах и мобильных устройствах.|
