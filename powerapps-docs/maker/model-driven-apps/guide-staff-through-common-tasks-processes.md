...
-   Бизнес-процессы и действия. Настройщики Dynamics 365 Customer Engagement могут быть знакомы с классическими процессами CDS для приложений, то есть бизнес-процессами и действиями. Дополнительные сведения: [Использование бизнес-процессов](/flow/workflow-processes) и [Обзор действий](/flow/actions)
...
[Применение бизнес-логики с помощью Common Data Service для приложений](../common-data-service/cds-processes.md)
