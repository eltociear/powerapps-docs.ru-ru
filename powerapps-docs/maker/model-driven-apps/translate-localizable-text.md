...
> [!TIP]
> При включении языков обратите внимание на значения LCID, используемые для каждого языка. Это значение представляет язык в экспортированных данных для локализуемого текста. Коды языка — это идентификаторы языкового стандарта из четырех или пяти разрядов. Допустимые значения идентификаторов см. в статье [Диаграмма кодов языка (LCID)](https://go.microsoft.com/fwlink/?LinkId=122128).
...
3. В строке меню выберите **Переводы** > **Экспорт переводов**. 

    > [!div class="mx-imgBorder"] 
    > ![Экспорт переводов](media/export-localizable-text.png "Экспорт переводов")
...
![Экспортированный текст для локализации](media/localized-labels-tab-exported-languages.png "Экспортированный текст для локализации")
...
> [!div class="mx-imgBorder"] 
> ![Импорт выбранного файла](media/import-translated-text-dialog.png "Импорт локализованного текста")
