...
В этом разделе вы узнаете, как настраивать настраиваемый элемент управления для поля. 
...
7.  Выберите значок карандаша ![Значок изменения свойств настраиваемого элемента управления](media/ccf-pencil-icon.png "Значок изменения свойства пользовательского элемента управления") рядом с полями **Мин.**, **Макс.** и **Шаг**, задайте параметр свойства, описанный ниже, затем выберите **ОК**.  
  
   > [!div class="mx-imgBorder"] 
   > ![Добавление свойств пользовательского элемента управления](media/ccf-add-properties.png "Добавление свойств пользовательского элемента управления")
