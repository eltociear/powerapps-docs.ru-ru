...
В этой теме показано, как создать бизнес-правила и рекомендации, чтобы применить логику формы в управляемом моделью приложении без написания кода JavaScript или создания подключаемых модулей. Бизнес-правила предоставляют простой интерфейс для реализации и поддержки быстро меняющихся, широко используемых бизнес-правил. Их можно применить к основной форме и форме быстрого создания, и они работают в управляемых моделью приложениях, веб-приложениях Dynamics 365 Customer Engagement, Dynamics 365 for tablets и Dynamics 365 for Outlook (интерактивный и автономный режимы).

> [!NOTE]
> Чтобы определить бизнес-правило для сущности для применения ко всем формам и серверу см. раздел [Создание бизнес-правила для сущности](/powerapps/maker/common-data-service/data-platform-create-business-rule).
...
### <a name="full-name-field-not-supported-with-unified-interface-apps"></a>Поле полного имени не поддерживается с приложениями единого интерфейса
Действия или условий, использующие поле **Полное имя** (fullname) не поддерживаются в приложениях, основанных на едином интерфейсе.  Кроме того, можно использовать действия или условия с полями **Имя** (firstname) и **Фамилия** (lastname). 

### <a name="is-your-business-rule-not-firing-for-a-form"></a>Ваше бизнес-правило не срабатывает для формы?
...
- См. пункт [Ваше бизнес-правило не срабатывает для формы?](#is-your-business-rule-not-firing-for-a-form) в этом разделе.
