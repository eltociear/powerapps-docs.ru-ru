...
2. На странице **Создать** наведите указатель на пример приложения и нажмите **Создать приложение**.

![Пример управляемого моделью приложения](media/overview-model-driven-samples/model-driven-create-page-sample.png)
