...
2. На странице **Создание** наведите указатель мыши на пример приложения и выберите команду **сделать это приложение**.

![Пример приложения модели](media/overview-model-driven-samples/model-driven-create-page-sample.png)
