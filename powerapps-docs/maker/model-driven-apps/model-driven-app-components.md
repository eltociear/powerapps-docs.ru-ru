---
title: Общие сведения о компонентах управляемых моделью приложений в Power Apps | MicrosoftDocs
...
> ![Конструктор приложений и конструктор форм](media/model-driven-app-overview/app-and-form-designers.png "Конструктор приложений и конструктор форм")
...
|Flow     | Flow — это облачный сервис, который позволяет создавать автоматизированные бизнес-процессы между приложениями и службами, чтобы получать уведомления, синхронизировать файлы, собирать данные и т. п.        | Power Automate        |

![Конструкторы бизнес-процессов, действий и последовательностей операций бизнес-процесса](media/model-driven-app-overview/designer-mash.png "Конструкторы бизнес-процессов, действий и последовательностей операций бизнес-процесса")
...
### <a name="additional-options-for-adding-custom-business-logic"></a>Дополнительные параметры для добавления настраиваемой бизнес-логики
[Использование подключаемых модулей для расширения бизнес-процессов](../../developer/common-data-service/plug-ins.md) <br />
[Расширения бизнес-процессов](../../developer/common-data-service/workflow/workflow-extensions.md)
...
|Внедренный Power BI     | Добавляет плитки внедренного Power BI и панели мониторинга в приложение. Power BI — это облачный сервис, предоставляющий бизнес-аналитику.        |  Комбинация конструктора диаграмм, конструктора панелей мониторинга и Power BI       |

> [!div class="mx-imgBorder"] 
> ![Пример панели мониторинга](media/model-driven-app-overview/dashboard-designer.png "Пример панели мониторинга")
...
> [!div class="mx-imgBorder"] 
> ![Обозреватель решений](media/model-driven-app-overview/solutionexplorer-entitiescollapsed.png "Обозреватель решений")

ЧТобы открыть обозреватель решений, 

1. На домашней странице [!INCLUDE [powerapps](../../includes/powerapps.md)] выберите **Параметры**, а затем выберите **Дополнительные параметры**.

2. На странице управления бизнесом Dynamics 365 выберите **Параметры**, выберите **Настройки**, а затем выберите **Настроить систему**.

  > [!div class="mx-imgBorder"] 
  > ![Откройте обозреватель решений](media/model-driven-app-overview/app-settings-solutions-explorer.png "Открыть обозреватель решений")
