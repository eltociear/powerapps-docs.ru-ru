...
5. В конструкторе представлений выберите кнопку со знаком "плюс" для добавления дополнительных столбцов, которые требуются показывать в представлении. Дополнительные сведения: [Добавление столбца в представление](#add-a-column-to-your-view)
