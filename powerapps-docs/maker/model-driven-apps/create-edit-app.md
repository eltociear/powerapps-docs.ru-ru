...
2. На странице **Создать приложение** введите следующие сведения: 
...
3. Выберите **Готово** или, если выбран вариант **Использовать имеющееся решение для создания приложения**, щелкните **Далее** для выбора из доступных решений, импортированных в организацию.  
