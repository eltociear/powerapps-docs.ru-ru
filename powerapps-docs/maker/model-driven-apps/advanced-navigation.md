...
4.  В списке доступных решений выберите требуемое решение в столбце **Отображаемое имя**, чтобы открыть обозреватель решений.
...
Используйте область параметров для настройки параметров среды, активации или деактивации процессов и т. д. 
