...
- [Power BI регистрация службы](http://powerbi.com/).  
...
- Файл PBIX для пакета содержимого, который нужно настроить.  
  ...
  -   [Загрузите файл Dynamics CRM Online Service Manager PBIX](http://download.microsoft.com/download/9/2/B/92BCBDCE-CE01-4BC9-A306-2A92653B683E/Customer%20Service%20Manager.pbix)  
  
  -   [Загрузите файл PBIX для Microsoft Dynamics 365 Process Analyzer](http://download.microsoft.com/download/9/2/B/92BCBDCE-CE01-4BC9-A306-2A92653B683E/Process%20Analyzer%20-1.34b.pbix)  
...
3. В правой области в разделе **ПРИМЕНЕННЫЕ ШАГИ** выберите кнопку настроек ![Кнопка настроек](media/mp-ua-r16-settings.png "Кнопка настроек") рядом с **Удаленные другие столбцы**.  
...
6. В правой области в разделе **ПРИМЕНЕННЫЕ ШАГИ** выберите кнопку настроек ![Кнопка настроек](media/mp-ua-r16-settings.png "Кнопка настроек") рядом с **Удаленные другие столбцы**.  
...
1. Добавьте столбец настраиваемого поля.  
   ...
   -   В правой области в разделе **ПРИМЕНЕННЫЕ ШАГИ** выберите кнопку настроек ![Кнопка настроек](media/mp-ua-r16-settings.png "Кнопка настроек") рядом с **Удаленные другие столбцы**.  
...
2. Создайте запрос набора параметров.  
   ...
   ![Создание запроса набора параметров](media/pbi-makeoptionsetquery.png "Создание запроса набора параметров")  
...
3. Вставьте запрос слияния для таблиц сущности и настраиваемого набора параметров.  
   ...
   ![Выбор слияния таблиц](media/pbi-merge-tables.png "Выбор слияния таблиц")  
