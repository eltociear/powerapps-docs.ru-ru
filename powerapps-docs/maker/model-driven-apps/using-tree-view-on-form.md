...
Можно также использовать представление в виде дерева для выбора полей и компонентов в форме. Представление в виде дерева полезно, когда требуется выбрать скрытые элементы, которые не видны в представлении предварительного просмотра формы. 
