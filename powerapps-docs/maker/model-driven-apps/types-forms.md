---
title: Тип форм управляемых моделью приложений в Power Apps | Документация Майкрософт
...
ms.locfileid: "2884264"
---
# <a name="type-of-model-driven-app-forms-in-power-apps"></a>Тип форм управляемых моделью приложений в Power Apps
...
|**Карточка** | Используется в представлениях для приложений Power Apps. Формы карточек предназначены для представления данных в компактном формате, подходящем для мобильных устройств. | [Создание формы карточки](create-card-forms.md) |
