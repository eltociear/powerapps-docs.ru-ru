...
1. Войдите в [Power Apps](https://make.powerapps.com/?utm_source=padocs&utm_medium=linkinadoc&utm_campaign=referralsfromdoc) и откройте существующее приложение для редактирования. 
...
Отчеты поддерживают решения. При добавлении отчета в решение в качестве компонента он становится отдельным программным модулем, расширяющим возможности системы Power Apps и пользовательский интерфейс. В решения можно добавлять только отчеты, доступные для просмотра в организации.
...
[Добавление отчета, созданного вне Power Apps](/powerapps/user/add-existing-report)<br/>
