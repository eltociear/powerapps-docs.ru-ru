...
С помощью Power Apps управляемые моделью приложения составляются из компонентов, таких как сущности, панели мониторинга, формы, представления, диаграммы и бизнес-процессы.  
