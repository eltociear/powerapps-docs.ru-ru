...
5.  Создайте веб-ресурс JavaScript и добавьте его к форме:  
...
7. Выберите **ОК**, чтобы закрыть диалог **Свойства формы**.  
  
8. Выберите **Сохранить и закрыть**, чтобы закрыть форму.  
  
9. В обозревателе решений выберите **Опубликовать все настройки**.  
