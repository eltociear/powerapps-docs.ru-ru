---
title: Свойства специальных полей управляемых моделью приложений для основных форм в Power Apps | MicrosoftDocs
description: Познакомьтесь со специальными свойствами полей для основных форм
Keywords: Основные формы; Специальные свойства полей; Dynamics 365
author: Mattp123
applies_to:
- Dynamics 365 (online)
