---
title: Создание карты сайта управляемого моделью приложения для приложения в PowerApps | Документация Майкрософт
...
1. На холсте конструктора приложений в области **Карта сайта** выберите **Открыть конструктор карты сайта** ![Кнопка открытия конструктора карты сайта](media/dynamics365-open-designer.PNG "Кнопка открытия конструктора карты сайта").  
   ...
   ![Выберите карту сайта](media/app-designer-sitemap-location.png "Выберите карту сайта") 
