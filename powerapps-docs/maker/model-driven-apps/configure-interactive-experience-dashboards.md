...
## <a name="configure-fiter-fields-and-security-roles-for-the-interactive-dashboards"></a>Настройка полей фильтра и ролей безопасности для интерактивных панелей мониторинга  
