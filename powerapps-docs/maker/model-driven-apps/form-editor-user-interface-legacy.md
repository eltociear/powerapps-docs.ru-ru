---
title: Обзор пользовательского интерфейса редактора форм управляемого моделью приложения для Power Apps | Документация Майкрософт
description: Познакомьтесь с пользовательским интерфейсом редактора форм для редактирования форм в Power Apps
author: Mattp123
applies_to:
- Dynamics 365 (online)
...
||**Таймер**|Вставка элемента управления "Таймер" в форму сущности для отслеживания времени по SLA. Дополнительные сведения: [Добавление элемента управления "Таймер"](https://docs.microsoft.com/dynamics365/customer-engagement/customer-service/add-timer-control-case-form-track-time-against-sla)|
||**Поиск в базе знаний**|Вставка элемента управления "Поиск", с помощью которого пользователи смогут выполнять поиск статей базы знаний. Дополнительные сведения: [Элемент управления поиска в базе знаний](https://docs.microsoft.com/dynamics365/customer-engagement/customer-service/add-knowledge-base-search-control-forms)|  
