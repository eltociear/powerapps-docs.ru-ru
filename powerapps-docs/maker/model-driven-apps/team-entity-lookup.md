...
> ![](media/entity-lookup-teams.png "Подстановка сущности с доступными пользователями и рабочими группами")
...
> [!div class="mx-imgBorder"] 
> ![](media/entity-lookup-user-only.png "Подстановка сущности только с пользователями")
...
2. Выберите вкладку **Компоненты**, выберите **Сущности**, затем выберите **Рабочая группа**.    
    ...
    > [!div class="mx-imgBorder"] 
    > ![](media/add-team-entity-app.png "Добавление сущности рабочей группы в приложение")
