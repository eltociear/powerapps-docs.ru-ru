...
Чтобы перейти к визуальному элементу PowerApps с помощью клавиатуры, выполните следующие действия.

1. Выделение фокуса на Power BI отчете для требуемого визуального элемента PowerApps.
