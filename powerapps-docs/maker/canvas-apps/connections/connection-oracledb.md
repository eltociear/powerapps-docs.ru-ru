...
Локальный шлюз данных выступает в качестве моста, обеспечивая быструю и безопасную пересылку данных между локальными данными (данными, которые не находятся в облаке) и службами Power BI, Power автоматизиру, Logic Apps и Power Apps. Вы можете использовать один шлюз с несколькими службами и несколькими источниками данных. Дополнительные сведения см. в статье [Общие сведения о локальных шлюзах данных в Microsoft PowerApps](../gateway-reference.md).
...
1. В Power Apps Studio щелкните **создать** в меню **файл** (рядом с левой границей).
