...
1. Рассмотрим некоторых пользователей, на которых подписаны, с помощью коллекции **С текстом**:  
   ...
   * Чтобы отобразить пользователей другой пользователь, задайте **[элементы](../controls/properties-core.md)** свойства коллекции следующую формулу:
...
Получите временную шкалу пользователя: Извлекает коллекцию последних твитов, опубликованную указанным пользователем
...
Получение домашней временной шкалы: Извлекает последние твиты и ретвиты пользователя и его подписчиков
...
Поиск твита: Извлекает коллекцию актуальных твитов, соответствующих указанному запросу
...
Получите читателей: Извлекает данные о пользователях, подписавшихся на указанного пользователя
...
Получите моих читателей: Извлекает данные о подписчиках пользователя
...
Получить из следующих шагов. Извлекает данные о пользователях, на которых подписан указанный пользователь
...
Получите читаемых мною пользователей: Извлекает данные о пользователях, на которых подписан пользователь
...
### <a name="user"></a>User
Получите пользователя: Извлекает подробные сведения об указанном пользователе (например, имя пользователя, описание, число подписчиков и т. д.)
