...
1. Рассмотрим некоторых пользователей, на которых подписаны, с помощью коллекции **С текстом**:  
   ...
   * Чтобы увидеть, какие пользователи находятся под другим пользователем, задайте для свойства коллекции **[Items](../controls/properties-core.md)** следующую формулу:
...
Получить временную шкалу пользователя: Извлекает коллекцию последних твитов, опубликованную указанным пользователем
...
Получить начальную временную шкалу: Извлекает последние твиты и ретвиты пользователя и его подписчиков
...
Получить подписчиков: Извлекает данные о пользователях, подписавшихся на указанного пользователя
...
Получить мои подписчиков: Извлекает данные о подписчиках пользователя
...
Получить следующее: Извлекает данные о пользователях, на которых подписан указанный пользователь
...
Получить следующее: Извлекает данные о пользователях, на которых подписан пользователь
...
Когда появится новый твит: Запускает рабочий процесс при публикации нового твита, который соответствует условиям поиска
