...
ms.locfileid: "79212269"
---
# <a name="connect-to-cloud-storage-from-power-apps"></a>Подключение к хранилищу в облаке из Power Apps
...
Вы можете предоставить другим пользователям в организации общий доступ к своим [данным](../share-app.md), [приложению](../share-app-resources.md) и [ресурсам](../share-app-data.md), таким как соединители.
