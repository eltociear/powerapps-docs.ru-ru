...
description: В PowerApps создайте раскрывающийся список, который фильтрует другой раскрывающийся список в приложении Canvas.
author: emcoope-msft
manager: kvivek
...
1. Откройте список **инциденты** и выберите **PowerApps**  > **настроить формы**.
    ...
    Откроется вкладка браузер с формой по умолчанию в PowerApps Studio.
