...
* Формулы используются для чтения сведений и их представления в отображаемых элементах управления. Можно отобразить записи источника данных, используя коллекцию на экране и нажимая свойство **[Items](controls/properties-core.md)** в источнике данных: **Коллекция. Items = источник данных**.  Вы связываете элементы управления в коллекции с ней, используя свойство элементов управления **[Default](controls/properties-core.md)** .  
