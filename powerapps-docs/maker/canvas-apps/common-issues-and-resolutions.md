...
1. **Проблема камеры на мобильных устройствах с Android** (1 января 2019 г.)

    Если камера управления перестает работать на устройстве Android, повторно опубликовать приложение и снова открыть его на устройстве. В ответ на изменение в ОС Android был обновлен элемент управления камеры и приложение будет использовать преимущества обновления при повторной публикации.

1. **Прокрутка в коллекции изменяющаяся высота** (27 ноября 2018 г.)

    При возникновении ограничения при прокрутке вытащите его пальцем, Поднимайте его и начать снова прокрутки.

1. **Рисование с помощью мыши или сенсорного ввода не является smooth в PowerApps для Windows** (сентября 24, 2018)

    Рукописному имеет только частично поддерживает рисование с помощью мыши или сенсорного ввода в приложении Windows. Штрихи может возникать периодически. Для smooth рисования с помощью пера или запустить его в браузере.
...
1. <a name="out-of-memory"></a>**Нехватка памяти в браузере** (23 июля 2018 г.)
    ...
    Если вы превысили памяти при использовании PowerApps, попробуйте загрузка 64-разрядной версии Chrome, Microsoft Edge или Internet Explorer.
