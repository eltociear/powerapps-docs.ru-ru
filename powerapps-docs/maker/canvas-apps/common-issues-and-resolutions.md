...
1. **При импорте через Edge изображения камеры переворачиваются** (20 января 2020 г.)

    При использовании камеры и браузера Edge изображения могут переворачиваться.  Это связано с проблемой в браузере Edge.  Чтобы устранить эту проблему, используйте новый Edge Chromium или другой браузер.
