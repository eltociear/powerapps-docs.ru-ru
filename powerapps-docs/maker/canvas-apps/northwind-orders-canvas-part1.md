...
1. Так как мы будем работать с экранами и элементами управления далее, в PowerApps Studio переключиться обратно в **представление в виде дерева** в левой части, нажав кнопку с тремя значками квадратов с накоплением. Вы можете в любое время вернуться к **источникам данных** , нажав на значок цилиндра.
