...
Чтобы импортировать один или несколько компонентов из одного приложения в другой, выберите **импорта компонентов** в раскрывающемся списке компонентов. Диалоговое окно перечислены все приложения, которые содержат компоненты, которые у вас есть разрешения на изменение. Выберите приложение, а затем выберите **импорта** для импорта последней опубликованной версии всех компонентов в таком приложении. После импорта хотя бы один компонент, можно изменить свою копию и удалять ненужные.

> [!div class="mx-imgBorder"]
> ![Диалоговое окно импорта компонентов](./media/create-component/import-components.png)

Если вы экспортируете компонента, создается локальный файл, который можно импортировать в другое приложение. Если приложение содержит измененную версию того же компонента, будет предложено решить, следует ли заменить измененной версии или Отмена импорта. 
