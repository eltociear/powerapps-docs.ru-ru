...
1. Скопируйте эти данные и вставьте их в файл Excel.
    ...
    | StartDay | StartTime | Доброволец | "Резервная копия" |
    | --- | --- | --- | --- |
