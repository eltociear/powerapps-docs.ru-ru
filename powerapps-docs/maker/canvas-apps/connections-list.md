...
Дополнительные сведения о том, как настраивать формулы с таблицами, см. в статьях:
...
Дополнительные сведения о том, как настраивать формулы для пользовательских обновлений, см. в статьях:

[Patch](functions/function-patch.md)<br>[Collect](functions/function-clear-collect-clearcollect.md)<br>[Update](functions/function-update-updateif.md)

> [!NOTE]
>  **PowerApps не работает с динамической схемы**. Динамическая схема фразу относится к тому, что те же действия могут возвращать другую таблицу с различными столбцами. Условия, которые могут вызвать столбцы в таблицах отличается включают входные параметры действия, пользователь или роль, которая выполняет действие и группы, в которой работает пользователь, помимо прочего. Например хранимых процедур SQL Server может возвращать разные столбцы, если имеют разные входные данные. Для действий с помощью динамической схемы показывает документации по соединителям **выходные данные этой операции являются динамическими.** как возвращаемое значение. Напротив Microsoft Flow работает с динамической схемы и может обеспечить обходного пути для вашего сценария.
