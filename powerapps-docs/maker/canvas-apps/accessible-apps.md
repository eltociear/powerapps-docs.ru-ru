...
- Метка, изображение, значок, элементов управления фигур - если они представляют интерактивные элементы (украшения) задайте для свойства TabIndex значение 0; Если они декоративных элементов или текста, задайте для свойства TabIndex значение -1.
...
- **Windows**: Microsoft Edge или экранного диктора
...
Убедитесь, что все видео сопровождаются субтитрами и что текстовая запись аудио доступна пользователям.  **Видео** элемент управления поддерживает субтитры в формате WebVTT через **ClosedCaptionsUrl** свойство.
