...
description: Отображение текста, дат и времени в приложении для холста в Power Apps
author: tapanm-msft
manager: kvivek
...
ms.locfileid: "74733003"
ms.PowerAppsDecimalTransform: true
---
# <a name="show-text-dates-and-times-in-power-apps"></a>Отображение текста, дат и времени в Power Apps
...
Например, можно добавить данные от пользователей о акциях или собраниях клиентов, данных из внешнего источника или данных из другого приложения, созданного в Power Apps. Если данные содержат время с точностью до миллисекунд, округлите его до ближайшей минуты, чтобы облегчить восприятие. Рассчитайте, сколько дней осталось до основной вехи. Если вы хотите планировать встречи с клиентами на каждые пять дней, то можете автоматически рассчитать эти даты. Если дата "10 мая 1985 года" хранится в отдельных полях дня, месяца и года, их можно объединить в отдельное значение. И наоборот, если приложение управляет ими отдельно, можно разбить каждую дату на отдельные значения.
