...
ms.locfileid: "78970967"
ms.PowerAppsDecimalTransform: true
---
# <a name="export-control-and-import-control-in-power-apps"></a>Экспорт управления и импорт элементов управления в Power Apps
Элементы управления для экспорта данных в локальный файл и последующего импорта этих данных в другое приложение в Power Apps.

## <a name="description"></a>Описание
Если необходимо создать несколько приложений, в которых используются одни и те же данные и только в их пределах, эти данные можно экспортировать и импортировать с помощью элементов управления **Экспорт** и **Импорт**. При экспорте данных создается сжатый файл, который можно скопировать на другой компьютер, но вы не сможете прочитать его в любой программе, отличной от Power Apps.
...
1. Добавьте элемент управления **[Кнопка](control-button.md)** и задайте следующую формулу в качестве значения свойства **[OnSelect](properties-core.md)** : <br>
   ...
   ```
   Дополнительные сведения см. [в статье Добавление, именование и настройка элемента управления](../add-configure-controls.md), **[клеарколлект](../functions/function-clear-collect-clearcollect.md)** и [других функций](../formula-reference.md).
2. Нажмите клавишу F5 и выберите элемент управления **["Кнопка"](control-button.md)** , а затем нажмите клавишу ESC.
3. Добавьте элемент управления **Экспорт** и задайте для его свойства **Data** значение **Products**.
4. Нажмите клавишу F5 и выберите элемент управления **экспортом** , чтобы скачать файл *Data. zip*.
5. Выберите **сохранить**, а затем нажмите клавишу ESC, чтобы вернуться к рабочей области по умолчанию.
...
7. Нажмите клавишу F5, выберите **MyData**, затем выберите экспортированный файл и нажмите кнопку **Открыть**.
8. Нажмите клавишу ESC, выберите **коллекции** в меню **файл** и убедитесь, что в текущем приложении есть экспортированные данные.


## <a name="accessibility-guidelines"></a>Руководство по настройке специальных возможностей
**Экспорт[ и ](control-button.md)Импорт** — это всего лишь специальные кнопки, поэтому см. инструкции для элементаКнопка.
