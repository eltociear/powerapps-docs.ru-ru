...
1. Выберите элемент управления **[изображение](control-image.md)** в коллекции и задайте для его свойства **Image** **значение сиситем. Value**.
1. Нажмите клавишу F5 и выберите элемент управления **[Кнопка](control-button.md)** .
   
    Изображение из элемента управления **Добавление рисунка** отображается в **вертикальном** элементе управления аллери. Если изображение не имеет тех же пропорций, что и элемент управления **[изображением](control-image.md)** в **вертикальном** элементе управления "Коллекция", задайте для свойства **[Имажепоситион](properties-visual.md)** элемента управления **[изображение](control-image.md)** значение **вписать**.
1. Нажмите элемент управления **Добавить изображение**, выберите другой файл изображения, нажмите **Открыть**, а затем нажмите добавленный вами элемент управления **[Кнопка](control-button.md)** .
   
    В элементе управления **Коллекция изображений** появляется второе изображение.
1. (Необязательно) Повторите предыдущее действие один и несколько раз, а затем нажмите клавишу ESC, чтобы вернуться в рабочую область по умолчанию.
