...
1. Отправка и удаление рабочих функций только внутри формы. Элемент управления вложениями отключен при в режиме редактирования, а не в форме. Чтобы сохранить файл добавления и удаления, пользователь приложения должен сохранить форму. Из-за этого ограничения, элемент управления вложениями недоступен из **вставить** но появится вкладка в форме при включении вложения поля формы в форме SharePoint или Common Data Service.

1. Вы можете передать файлы только в том случае, если они 10 МБ или меньше.  
