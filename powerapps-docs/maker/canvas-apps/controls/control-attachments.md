...
1. Функции отправки и удаления работают только внутри формы. Элемент управления "вложение" отображается как отключенный в режиме редактирования, а не внутри формы. Чтобы сохранить добавления и удаления файлов, пользователь приложения должен сохранить форму. Из-за этого ограничения элемент управления "вложение" недоступен на вкладке " **Вставка** ", но отображается в форме при включении поля формы вложения в SharePoint или Common Data Service форме.
