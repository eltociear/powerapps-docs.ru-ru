...
Те же правила применяются к элементу **[Button](control-button.md)** так как элемент **Microphone** — это просто специализированная кнопка. Кроме того, рассмотрим следующее.
