...
Можно задать цвета различными способами:

- [**Цвет** ](../functions/function-colors.md) перечисления: Укажите имена цветов из таблиц каскадных стилей, как в следующих примерах:

  - **Color.Red**
  - **Color.Indigo**

- [**ColorValue** ](../functions/function-colors.md) функции: Укажите текстовые строки, такие как имена цветов из таблицы каскадных стилей и представлением в виде шестнадцатеричного кода ( **#** ), как показано в этих примерах:

  - **ColorValue( "AliceBlue" )**
  - **ColorValue( "#ff00ff" )**

- [**ColorFade** ](../functions/function-colors.md) функции: Задавая как затененный цвет, от полностью черным (-100%) полностью белому (100%), как в следующем примере:

  - **ColorFade (Color.Red, 50%)**

- [**RGBA** ](../functions/function-colors.md) функции: Укажите красного, зеленого и синего компонентов цвета, от 0 до 255 и указать альфа-канал от 0% (полностью прозрачный) до 100% (полностью непрозрачный), как в следующем примере:

  - **RGBA (255, 0, 255, 25%)**

Свойства цвета можно также ссылаться на другие свойства цвета. Например **Label.PressedColor** может задаваться формула **Label1.Color**, автоматически каскадных изменений из одного свойства в другой.
