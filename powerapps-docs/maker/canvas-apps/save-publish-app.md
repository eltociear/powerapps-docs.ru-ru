...
1. В Power Apps Studio выберите **Сохранить** в меню **Файл** (у левого края окна), а затем выберите **Опубликовать**.
    ...
    ![Опубликовать приложение](./media/save-publish-app/publish-app.png)
...
Чтобы опубликовать последнюю версию, выделите версию и нажмите кнопку с многоточием (...). Затем выберите **опубликовать эту версию** в раскрывающемся меню.
