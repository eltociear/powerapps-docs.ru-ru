...
**[Сканер штрихкодов](controls/control-new-barcode-scanner.md)** — проверяет штрихкоды, QR-коды и коды матриц данных на устройстве Android или iOS.
...
**[Редактор форматированного текста](controls/control-richtexteditor.md)** — позволяет пользователям приложений применять форматированный текст.
...
**[Сканер веб-штрихкодов (экспериментальный)](controls/control-barcodescanner.md)** — устаревший сканер штрихкодов, который является устаревшим, но может быть полезен для сканирования кодов в веб-браузере.
