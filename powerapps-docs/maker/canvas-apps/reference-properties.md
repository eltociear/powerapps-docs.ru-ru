...
**[Сканер штрихкодов](controls/control-new-barcode-scanner.md)**  — сканирует штрихкоды, QR-коды и двухмерные матричные коды на устройстве с Android или iOS.
...
**[Флажок](controls/control-check-box.md)** — установка или снятие флажка для задания значения **true** или **false**.
...
**[Контейнер (экспериментальный)](controls/control-container.md)**  — создание вложенной иерархии для обеспечения доступности и скорости реагирования. 
...
**[Экспорт](controls/control-export-import.md)**  — экспорт данных для использования в любом компоненте Power Apps.
...
**[Импорт](controls/control-export-import.md)**  — импорт данных из любого компонента в Power Apps.
...
**[Плитка Power BI](controls/control-power-bi-tile.md)** — отображение плитки Power BI внутри приложения.
...
**[Редактор форматированного текста](controls/control-richtexteditor.md)**  — позволяет пользователям приложения форматировать текст.
...
**[Потоковая передача видео](controls/control-stream-video.md)**  — воспроизведение видео и просмотр каналов из службы Microsoft Stream.
...
**[Веб-сканер штрихкодов (экспериментальный)](controls/control-barcodescanner.md)**  — устаревший сканер штрихкодов, который может оказаться полезен для сканирования кодов в веб-браузере.
...
**AutoPause** — определяет, приостанавливается ли автоматически звуковой или видеоклип при переходе пользователя на другой экран.  Применяется к элементам управления **[Звук](controls/control-audio-video.md)** , **[Таймер](controls/control-timer.md)** и **[Видео](controls/control-audio-video.md)** .

**AutoStart** — определяет, запускается ли автоматически элемент управления "Звук" или "Видео" для воспроизведения клипа при переходе пользователя на экран с таким элементом управления.  Применяется к элементам управления **[Звук](controls/control-audio-video.md)** , **[Таймер](controls/control-timer.md)** и **[Видео](controls/control-audio-video.md)** .
...
**[CheckboxSize](controls/control-check-box.md)**  — ширина и высота поля, окружающего значок флажка в элементе управления "Флажок".  Применяется к элементу управления **[Флажок](controls/control-check-box.md)** .
...
**[DisabledBorderColor](controls/properties-color-border.md)**  — цвет границы элемента управления, если его свойство **[Disabled](controls/properties-core.md)** имеет значение **true**.  Применяется к многим элементам управления.
...
**[FindPrevious](controls/control-pdf-viewer.md)**  — поиск предыдущего экземпляра **FindText** в документе.  Применяется к элементу управления **[Средство просмотра PDF](controls/control-pdf-viewer.md)** .
...
**Layout** — направление прокрутки коллекции или передвижения ползунка пользователем: **Vertical** (сверху вниз) или **Horizontal** (слева направо).  Применяется к элементам управления **[Коллекция](controls/control-gallery.md)** и **[Ползунок](controls/control-slider.md)** .
...
**[OriginalHeight](controls/control-image.md)** — исходная высота изображения (активируется свойством **[CalculateOriginalDimensions](controls/control-image.md)** ).  Применяется к элементу управления **[Изображение](controls/control-image.md)** .
...
**ReadOnly** — определяет, может ли пользователь изменить значение ползунка или оценки.  Применяется к элементам управления **[Оценка](controls/control-rating.md)** и **[Ползунок](controls/control-slider.md)** .
...
**[SelectionFill](controls/properties-color-border.md)**  — цвет фона выбранного элемента или элементов списка или цвет выделенной области элемента управления "Ввод с помощью пера".  Применяется к элементам управления **[Раскрывающийся список](controls/control-drop-down.md)** и **[Поле со списком](controls/control-list-box.md)** .
...
**ShowValue** — определяет, отображается ли значение ползунка или оценки, когда пользователь изменяет это значение или наводит указатель на элемент управления.  Применяется к элементам управления **[Оценка](controls/control-rating.md)** и **[Ползунок](controls/control-slider.md)** .
...
**Start** — определяет, воспроизводится ли звуковой или видеоклип.  Применяется к элементам управления **[Звук](controls/control-audio-video.md)** , **[Таймер](controls/control-timer.md)** и **[Видео](controls/control-audio-video.md)** .
...
**[StartYear](controls/control-date-picker.md)** — наиболее ранний год, который пользователь может выбрать в элементе управления "Средство выбора даты".  Применяется к элементу управления **[Средство выбора даты](controls/control-date-picker.md)** .
...
**[Transparency](controls/control-image.md)** — прозрачность, или степень того, насколько видны элементы управления за изображением.  Применяется к элементу управления **[Изображение](controls/control-image.md)** . Десятичные значения находятся в диапазоне от 0 до 1.  Если 0 является непрозрачным, 0,5 является частично прозрачным, а 1 — прозрачным.
...
**ValueFill** — фоновый цвет прямоугольника в переключателе, когда он имеет значение **true**, или цвет линии слева от маркера ползунка.  Применяется к элементам управления **[Ползунок](controls/control-slider.md)** и **[Переключатель](controls/control-toggle.md)** .
