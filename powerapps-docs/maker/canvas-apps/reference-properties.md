...
**[Форма сущности](entity-form-control.md)**  — экспериментальная функция: Добавьте динамические формы, в которых пользователи могут просматривать и редактировать реляционные данные из Common Data Service, а также перемещаться по этим данным.
...
**[FontWeight](controls/properties-text.md)**  — начертание шрифта для текста в элементе управления: **Bold**, **Semibold**, **Normal** или **Lighter**.  Применяется к многим элементам управления.
