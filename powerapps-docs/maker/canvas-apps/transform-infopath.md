...
Если вы по-прежнему нашли нужный параметр электронной почты, вы также можете использовать соединители Power Apps для тестов по электронной почте, Gmail, MailChimp, Outlook.com, SendGrid или SMTP. Возможности подключения — это очередное преимущество PowerApps.
