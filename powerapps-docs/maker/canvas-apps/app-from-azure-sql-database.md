...
- Вам нужна действительная лицензия на Power Apps или Зарегистрируйтесь на [30-дневную пробную версию лицензии](../signup-for-powerapps.md).
...
3. Выберите Power Apps.
    ...
    > [!NOTE]
    > Если у вас нет лицензии на использование Power Apps, вы увидите синюю информационную панель со ссылкой для запуска пробной версии. При выборе для запуска пробной версии на новой вкладке появится новая вкладка, где вы будете подписаться на лицензию. По завершении вернитесь к портал Azure и обновите колонку, чтобы продолжить.
...
- Для подключения к базе данных SQL Power Apps требуется проверка подлинности SQL.
