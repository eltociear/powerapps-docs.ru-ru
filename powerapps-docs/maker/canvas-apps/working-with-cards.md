...
description: В Power Apps используйте карточки форм, чтобы получать и отображать сведения из источника данных.
author: gregli-msft
manager: kvivek
...
Power Apps предлагает стандартный набор карточек для строк, чисел и других типов данных. В области справа можно просмотреть доступные варианты и изменить карту, используемую для поля.
...
Ниже приведены некоторые рекомендации о взаимодействии элементов управления с картами и карт с формой. Это только рекомендации. Как и в случае с любыми элементами управления Power Apps, можно создавать формулы, ссылающиеся на любой другой элемент управления в Power Apps, и это не менее верно для карточек и элементов управления в карточках. Приложение можно создать множеством способов. Реализуйте свой творческий потенциал!  
...
| Свойство элемента управления | Формула | Description |
| --- | --- | --- |
...
| Имя элемента управления | Формула | Description |
| --- | --- | --- |
