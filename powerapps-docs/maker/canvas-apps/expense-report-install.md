...
ms.locfileid: "74731472"
---
# <a name="install-and-configure-the-expense-report-sample-for-canvas-apps-in-power-apps"></a>Установка и Настройка образца отчета о затратах для приложений Canvas в Power Apps
