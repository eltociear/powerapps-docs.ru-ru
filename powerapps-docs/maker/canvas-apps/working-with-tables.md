...
Чтобы сослаться в формуле на саму запись вне контекста таблицы, воспользуйтесь фигурными скобками. Например, эта запись **{Name: "Клубника"; Цена: 7;99}** не связана с таблицей. Обратите внимание, что имена полей (**Name** и **Price** в этом примере) не заключаются в двойные кавычки.
