...
Можно просмотреть значения переменных, определения и использование с представлением переменные в меню **файл** в Power Apps Studio.
