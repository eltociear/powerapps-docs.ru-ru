...
description: Справочные сведения, включая синтаксис и примеры, для функций Sort и Сортбиколумнс в Power Apps
author: gregli-msft
manager: kvivek
...
ms.locfileid: "74730123"
ms.PowerAppsDecimalTransform: true
---
# <a name="sort-and-sortbycolumns-functions-in-power-apps"></a>Функции сортировки и Сортбиколумнс в Power Apps
