...
description: Справочные сведения, включая синтаксис и примеры, для функций фильтрации и поиска в Power Apps
author: gregli-msft
manager: kvivek
...
ms.locfileid: "74731074"
ms.PowerAppsDecimalTransform: true
---
# <a name="filter-search-and-lookup-functions-in-power-apps"></a>Функции фильтрации, поиска и поиска в Power Apps
