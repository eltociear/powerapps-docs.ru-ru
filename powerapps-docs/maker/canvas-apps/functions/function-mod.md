...
description: Справочные сведения, включая синтаксис и примеры, для функции mod в Power Apps
author: gregli-msft
manager: kvivek
...
ms.locfileid: "74730502"
ms.PowerAppsDecimalTransform: true
---
# <a name="mod-function-in-power-apps"></a>Функция mod в Power Apps
