...
| **Текст (1448318857000, "mmm. дд, гггг (чч: мм: сс AM/PM)»)** | Показывает значение даты времени Unix в понятном формате, если умножить исходное значение 1000. | «Ноября 23 2015 г. (02:47:37 PM)» |
