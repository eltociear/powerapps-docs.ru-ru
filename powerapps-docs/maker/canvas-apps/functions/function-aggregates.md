...
description: Справочные сведения по функциям СРЗНАЧ, Max, min, StdevP, Sum и VarP в Power Apps, включая синтаксис и примеры
author: gregli-msft
manager: kvivek
...
ms.locfileid: "74731449"
---
# <a name="average-max-min-stdevp-sum-and-varp-functions-in-power-apps"></a>Функции СРЗНАЧ, Max, min, StdevP, Sum и ДИСПР в Power Apps
