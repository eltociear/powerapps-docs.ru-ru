...
description: Справочные сведения, включая синтаксис и примеры, для функции Language в Power Apps
author: gregli-msft
manager: kvivek
...
| **"*lg*"** |*lg* — это двухсимвольное сокращенное название языка.  Это формат, используемый, когда Power Apps содержит сведения о языке, но не содержит сведений для конкретного региона. |
...
| Формула | Location | Возвращаемое значение |
| --- | --- | --- |
...
4. В Power Apps на правой панели щелкните вкладку **Источники данных** , а затем щелкните **Добавить источник данных**.
...
1. В Power Apps на правой панели щелкните вкладку **Источники данных** , а затем щелкните **Добавить источник данных**.
