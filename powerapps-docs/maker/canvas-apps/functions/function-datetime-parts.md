...
description: Справочные сведения, включая синтаксис и примеры для функций "день", "месяц", "год", "час", "минута", "время" и "Неделя" в Power Apps
author: gregli-msft
manager: kvivek
...
ms.locfileid: "74731141"
---
# <a name="day-month-year-hour-minute-second-and-weekday-functions-in-power-apps"></a>Функции дня, месяца, года, часа, минуты, секунды и дня недели в Power Apps
...
| **Minute(&nbsp;Now()&nbsp;)** |Возвращает данные времени в секундах из текущего значения даты и времени. |59 |
