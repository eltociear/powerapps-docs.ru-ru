...
* *Количество_символов* — обязательный (**слева** и **справа** только).  Число возвращаемых символов.  Если не указано для **Mid** функция, функция возвращает часть от начальной позиции до конца строки.
...
| **MID (Author.Text, 7)** |Извлекает все символы, начиная с седьмого знака в строке. |«Иванов» |
