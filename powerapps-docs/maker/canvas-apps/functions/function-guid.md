...
При создании нового идентификатора GUID, эта функция использует псевдослучайных чисел для создания версии 4 [IETF RFC 4122](https://www.ietf.org/rfc/rfc4122.txt) GUID. При преобразовании строки в идентификатор GUID, эта функция поддерживает любой идентификатор GUID версии, принимая любая строка 32 шестнадцатеричных цифр.
...
* **Patch (продукты, по умолчанию (продукты), {состояния: GUID( "F9168C5E-CEB2-4faa-B6BF-329BF39FA1E4" ) } )**
