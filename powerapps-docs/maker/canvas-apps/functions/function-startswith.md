...
description: Справочные сведения, включая синтаксис и примеры для функций EndsWith и StartsWith в Power Apps
author: gregli-msft
manager: kvivek
...
ms.locfileid: "74730082"
---
# <a name="endswith-and-startswith-functions-in-power-apps"></a>Функции EndsWith и StartsWith в Power Apps
