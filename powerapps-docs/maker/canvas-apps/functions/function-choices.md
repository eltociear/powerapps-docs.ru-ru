...
В настоящее время вы не можете [делегировать](../delegation-overview.md) **Выбор**. Если это ограничение создает в вашем приложении проблему, добавьте внешнюю сущность в качестве источника данных и используйте ее напрямую. 
...
1. В целях иллюстрации можно просмотреть полную **таблицу, возвращенную функцией Choice** в элементе управления **таблицы данных** .  На вкладке **Главная** выберите **Создать экран**, а затем — **Blank**.
