...
description: Справочные сведения, включая синтаксис и примеры, для функций ABS и sqrt в Power Apps
author: gregli-msft
manager: kvivek
...
ms.locfileid: "74729992"
ms.PowerAppsDecimalTransform: true
---
# <a name="acos-acot-asin-atan-atan2-cos-cot-degrees-pi-radians-sin-and-tan-functions-in-power-apps"></a>Функции Acos, Акот, ASIN, Atan, atan2, COS, COT, градусы, PI, радианы, Sin и Tan в Power Apps
