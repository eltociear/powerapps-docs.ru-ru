...
description: Справочные сведения, включая синтаксис и примеры, для функций DateAdd, DateDiff и TimeZoneOffset в Power Apps
author: gregli-msft
manager: kvivek
...
Дополнительные сведения см. в статьях [типы даты, времени и DateTime](/data-types#date-time-and-datetime) , а также [Работа с датами и временем](../show-text-dates-times.md) .
