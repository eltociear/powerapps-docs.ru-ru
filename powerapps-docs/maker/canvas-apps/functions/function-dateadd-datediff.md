...
description: Справочные сведения о функциях DateAdd, DateDiff и TimeZoneOffset в Power Apps, включая описание синтаксиса и примеры.
author: gregli-msft
manager: kvivek
...
ms.locfileid: "76708775"
ms.PowerAppsDecimalTransform: true
---
# <a name="dateadd-datediff-and-timezoneoffset-functions-in-power-apps"></a>Функции DateAdd, DateDiff и TimeZoneOffset в Power Apps
...
Также см. сведения о [типах данных даты и времени](../functions/data-types.md#date-time-and-datetime) и о [работе с датами и временем](../show-text-dates-times.md).
...
* *Единицы* — необязательный аргумент. Тип добавляемых *Единиц*: **Milliseconds** (миллисекунды), **Seconds** (секунды), **Minutes** (минуты), **Hours** (часы), **Days** (дни), **Months** (месяцы), **Quarters** (кварталы) или **Years** (годы).  Если значение не указано, используются единицы **Days**.
