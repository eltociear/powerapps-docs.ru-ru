...
Сигнал **Acceleration** возвращает значение ускорения устройства в трех измерениях относительно экрана устройства. Ускорение измеряется в единицах *g*, значение которого составляет 9,81 м/с<sup>2</sup> (речь идет об ускорении свободного падения, вызванного земным притяжением).
...
Дополнительные сведения: Документация по [объекту **приложения** ](object-app.md) .
...
| **Acceleration** |Возвращает сведения об ускорении в виде записи. |X 0, Y: 264, Z: 0}, так как это устройство выдается кувшином. |
