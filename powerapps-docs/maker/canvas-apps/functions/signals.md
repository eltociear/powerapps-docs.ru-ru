...
| **Location.Longitude** |Возвращает число от – 180 до 180, которое указывает долготу, измеряемую в градусах от GMT, Англия.  Положительное число указывает расположение, которое является Востоком Гринвхич. |
