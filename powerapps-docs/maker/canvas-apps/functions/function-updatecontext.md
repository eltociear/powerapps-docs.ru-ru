...
description: Справочные сведения, включая синтаксис и примеры, для функции Упдатеконтекст в Power Apps
author: gregli-msft
manager: kvivek
...
ms.locfileid: "74729899"
ms.PowerAppsDecimalTransform: true
---
# <a name="updatecontext-function-in-power-apps"></a>Функция Упдатеконтекст в Power Apps
...
Power Apps основано на формулах, которые автоматически пересчитываются по мере взаимодействия пользователя с приложением.  Переменные контекста не предоставляют эту возможность, а также могут усложнить как процесс создания, так и структуру самого приложения.  Прежде чем приступить к работе с переменной контекста, ознакомьтесь с [общими сведениями о переменных](../working-with-variables.md).
