...
description: Справочные сведения, включая синтаксис и примеры, для функций AddColumns, Дропколумнс, RenameColumns и Шовколумнс в Power Apps
author: gregli-msft
manager: kvivek
...
ms.locfileid: "74730044"
ms.PowerAppsDecimalTransform: true
---
# <a name="addcolumns-dropcolumns-renamecolumns-and-showcolumns-functions-in-power-apps"></a>Функции AddColumns, Дропколумнс, RenameColumns и Шовколумнс в Power Apps
