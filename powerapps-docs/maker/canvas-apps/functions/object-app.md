...
> объект приложения ![The в области представления в виде дерева @ no__t-1
...
> [!div class="mx-imgBorder"]
> контекстное меню ![App для запуска OnStart @ no__t-1
...
- Если приложение выполняется в PowerApps Mobile (iOS или Android):
  ...
  - Прокрутка для переключения на другое приложение в PowerApps Mobile.
...
1. Задайте для свойства **конфирмексит** объекта **приложения** следующее выражение:
    ...
    > [!div class="mx-imgBorder"]
    > @no__t-диалоговое окно подтверждения 0Generic @ no__t-1
...
1. Задайте для свойства **конфирмекситмессаже** объекта **приложения** следующую формулу:
    ...
    > [!div class="mx-imgBorder"]
    > ![Form — диалоговое окно подтверждения @ no__t-1
