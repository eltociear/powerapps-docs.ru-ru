...
description: Справочные сведения, включая синтаксис и примеры, для функций Now, Today и Today в Power Apps
author: gregli-msft
manager: kvivek
...
ms.locfileid: "74730527"
ms.PowerAppsDecimalTransform: true
---
# <a name="now-today-and-istoday-functions-in-power-apps"></a>Функции Now, Today и Today в Power Apps
