...
Могут помочь регулярные выражения в различные диалекты и PowerApps используется вариант диалекта JavaScript. См. в разделе [синтаксис регулярных выражений](https://msdn.microsoft.com/library/1400241x.aspx) введение в синтаксис. Поддерживаются именованные под-совпадений (иногда называется именованные группы записи):
