...
| **стартматч** | Number | Начальное расположение совпадения в строке входного текста. Первый символ строки возвращает 1. | 
...
* *Текст* — требуется. Текстовая строка для сопоставления.
