...
Эти типы данных не имеют существующие ограничения на их длины. Базовая реализация JavaScript в браузере или на устройстве может привести к повышению ограничение, но обычно свыше 100 МБ. Тем не менее объем доступной памяти на устройстве может привести к повышению другого ограничения, которая, вероятнее всего, меньше 100 МБ. Чтобы определить, будет ли приложение работать в рамках этих ограничений, протестируйте распространенные сценарии на всех устройствах, на которых он должен выполняться.
