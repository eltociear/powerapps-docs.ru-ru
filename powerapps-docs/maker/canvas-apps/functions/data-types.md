...
| **Изображение** | Объект [универсальный идентификатор ресурса (URI)](https://en.wikipedia.org/wiki/Uniform_Resource_Identifier) текстовую строку к изображению в .jpeg, PNG, .svg, .gif или другой формат, веб-образ. | **MyImage** добавлен в качестве ресурса приложения<br>**"https://northwindtraders.com/logo.jpg "**<br>**«appres://blobmanager/7b12ffa2...»** |
