...
### <a name="optional-sending-notifications-to-more-than-999-users"></a>Необязательно: отправка уведомлений более чем 999 пользователям

Действие текущего **получения членов группы** ограничено извлечением 999 пользователей (по умолчанию 100 пользователей). Чтобы распространить среди других пользователей, можно преобразовать их в последовательность, чтобы вместо этого отправить сообщение электронной почты в группу рассылки.
