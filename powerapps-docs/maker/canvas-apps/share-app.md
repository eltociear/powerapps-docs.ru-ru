...
| CandidateZip                                      | Нет                                                                     |
| Capsule CRM                                       | Нет                                                                     |
| Управление PKI в облаке                              | Нет                                                                     |
| Cognito Forms                                     | Нет                                                                     |
| Common Data Service                               | Нет                                                                     |
| Common Data Service (устаревшая версия)                      | Нет                                                                     |
| D&B Optimizer                                     | Нет                                                                     |
| Derdack SIGNL4                                    | Нет                                                                     |
| Disqus                                            | Нет                                                                     |
| Слияние в документ                                    | Нет                                                                     |
| Dynamics 365.                                      | Нет                                                                     |
| Dynamics 365 AI for Sales                         | Да                                                                    |
| Dynamics 365 for Finance and Operations                        | Нет                                                                     |
| Enadoc                                            | Нет                                                                     |
| Eventbrite                                        | Нет                                                                     |
...
| Vimeo                                             | Нет                                                                     |
| Webex Teams                                       | Нет                                                                     |
| Advanced Threat Protection в Защитнике Windows (ATP) | Нет                                                                     |
| Word Online (Бизнес)                            | Нет                                                                     |
