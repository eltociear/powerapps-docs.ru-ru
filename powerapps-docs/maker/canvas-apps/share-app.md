...
При внедрении приложения Canvas в SharePoint с помощью HTML-тега iFrame сослаться на приложение, используя полный веб-URL. Чтобы найти URL-адрес, перейдите на http://make.powerapps.com, выберите приложение, перейдите на вкладку " **сведения** ", и URL-адрес отобразится в разделе " **веб-ссылка**".
