...
> [!div class="mx-imgBorder"]
> ![на панели команд выберите PowerApps, а затем выберите настроить форму. PowerApps Studio откроется на той же вкладке браузера. Если откроется диалоговое окно "Добро пожаловать в PowerApps Studio", выберите пропустить.](./media/customize-list-form/create-form.gif)
...
**Ответ.** Вам нужен [план Office 365, который включает PowerApps](https://docs.microsoft.com/power-platform/admin/pricing-billing-skus#licenses).
