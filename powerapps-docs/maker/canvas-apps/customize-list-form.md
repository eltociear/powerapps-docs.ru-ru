...
> - Пользовательские формы для библиотек документов поддерживают только изменение пользовательских метаданных. Редактирование или управление файлами не поддерживается.
