...
* [Подключение Power Apps](add-data-connection.md) к учетной записи облачного хранилища (например, Dropbox, OneDrive или Google диск), в котором можно хранить файл Excel.
...
4. В Power Apps щелкните **создать** в меню **файл** (в левой части экрана, если вы еще не открыли приложение), а затем нажмите кнопку **Макет телефона** на плитке для вашей учетной записи облачного хранилища.
