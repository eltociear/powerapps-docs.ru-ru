...
Некоторые подключения (например, SQL Server с проверкой подлинности SQL или Windows) [неявно используются совместно](share-app-resources.md#implicit-sharing) с приложением при совместном использовании приложения с другими пользователями. Для других подключений пользователи должны создавать собственные подключения (например, OneDrive для бизнеса или SQL Server с проверкой подлинности Azure AD).
