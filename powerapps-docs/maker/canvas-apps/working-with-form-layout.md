...
Этот раздел написан так, как если бы у вас был источник данных с именем « **заказ на продажу** » и он содержит поля на предыдущем рисунке. Если у вас есть лицензия PowerApps Plan 2 или [пробная лицензия](../signup-for-powerapps.md) и системный администратор или права на настройку системы, можно [создать сущность](../common-data-service/data-platform-create-entity.md) в Common Data Service и добавить аналогичные поля. 
...
### <a name="filling-spaces-widthfit"></a>Заполнение пробелов: видсфит
