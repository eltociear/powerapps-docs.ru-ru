...
- **Приложения на основе модели** стандартный пользовательский Интерфейс и подключение к данным только в Common Data Service. Но вы можете легко создавать другие элементы, такие как представления, панели мониторинга и различные типы бизнес-логики.

Если выбрать среду, которая имеет базу данных Common Data Service, вы можете создать холст или приложений на основе модели с использованием того же **Главная** страницы.
...
- Управление сущностями, наборы параметров и интеграции данных в [Common Data Service](../common-data-service/data-platform-intro.md).
