...
| Расширенный | Приложение, использующее по крайней мере один соединитель Premium. Для доступа конечный пользователь должен иметь план приложений или план каждого пользователя.
