...
План "Power Apps на приложение" позволяет отдельным пользователям запускать 2 приложения на одном портале для конкретного бизнес-сценария на основе всех возможностей Power Apps. Этот план предоставляет пользователям простой способ приступить к работе с платформой до более широкой адаптации к масштабированию.

После того как администратор выделит приложения Power Apps в среду, они будут назначены нелицензированным пользователям, когда им будет предоставлен общий доступ к приложению в этой среде. Вы можете увидеть, как Администратор выделяет планы приложений в [этой статье](https://docs.microsoft.com/power-platform/admin/capacity-add-on).
...
>
> Возможность управления назначением плана приложения для приложения доступна только для приложений, которые находятся в среде, в которой в [центре администрирования Power Platform](https://admin.powerplatform.microsoft.com)были размещены планы приложений.  
