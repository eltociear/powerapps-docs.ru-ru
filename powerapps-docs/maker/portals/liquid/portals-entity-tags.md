...
Добавляет диаграммы PowerApps на веб-страницу. Тег "chart" можно добавить в поле "Копия" на веб-странице или в поле "Источник" на веб-шаблоне. Шаги для добавления диаграммы PowerApps на веб-страницу см. в разделе [Добавление диаграммы на веб-страницу на портале](https://docs.microsoft.com/en-us/dynamics365/customer-engagement/portals/add-chart).
...
> [!NOTE]
> Чтобы тег работал, необходимо [включить интеграцию Power BI](../admin/set-up-power-bi-integration.md) в центре администрирования портала. Если интеграция Power BI не включена, панель мониторинга или отчет не будет отображаться.
...
При добавлении безопасного отчета или панели мониторинга Power BI убедитесь, что к ней предоставлен общий доступ для Azure Active Directory или служб Power BI Embedded на порталах Dynamics 365. 
...
Дополнительные сведения о фильтрации отчета: [Фильтрация отчета с использованием параметров строки запроса в URL-адресе](https://docs.microsoft.com/en-us/power-bi/service-url-filters)
...
Отображает указанный объект порталов PowerApps как редактируемый на портале для пользователей с разрешением изменения содержимого для этого объекта. Доступные для редактирования объекты включают [page](liquid-objects.md#page), [snippets](liquid-objects.md#snippets) и [weblinks](liquid-objects.md#weblinks).  
...
Загружает список сущностей по идентификатору [GUID](http://en.wikipedia.org/wiki/Globally_unique_identifier). id должен быть строкой, которую можно анализировать как GUID.  
...
Загружает список сущностей по идентификатору **или** по имени. Если предоставленное значение ключа можно анализировать как [GUID](http://en.wikipedia.org/wiki/Globally_unique_identifier), список сущностей будет загружен по идентификатору. В противном случае он будет загружен по имени.
...
Этот параметр поддерживает [синтаксис средства синтаксического анализа запросов Lucene](http://lucene.apache.org/core/2_9_4/queryparsersyntax.html).
