...
ms.locfileid: "73542463"
---
# <a name="create-a-custom-page-template"></a>Создание пользовательского шаблона страницы

В этом примере мы создадим пользовательский шаблон страницы, используя жидкость и шаблон страницы, основанный на веб-шаблоне. [!INCLUDE[proc-more-information](../../../includes/proc-more-information.md)] [хранения исходного содержимого с помощью веб-шаблонов](store-content-web-templates.md). Нашей целью является создание простого шаблона с двумя столбцами, который использует [набор веб-ссылок](../configure/manage-web-links.md) в качестве левой навигации с содержимым страницы справа. 
...
![Макет одного столбца веб-шаблона](../media/web-template-two-column-layout.png "Макет одного столбца веб-шаблона")
...
> [!div class=mx-imgBorder]
![Макет веб-ссылок в Web Template — структура навигации слева](../media/web-template-weblinks-left-navigation-layout.png "Макет веб-ссылок в Web Template — структура навигации слева")  
...
> [!div class=mx-imgBorder]
![Макет веб-ссылок шаблона страницы — левая структура навигации](../media/page-template-weblinks-left-navigation-layout.png "Макет веб-ссылок шаблона страницы — левая структура навигации")  
...
> [!div class=mx-imgBorder]
![Веб-страница с левой навигацией](../media/web-page-left-navigation.png "Веб-страница с левой навигацией")  
