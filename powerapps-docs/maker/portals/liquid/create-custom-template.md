...
В этом примере мы создадим настраиваемый шаблон страницы с помощью Liquid и шаблона страницы, который основан на веб-шаблоне. [!INCLUDE[proc-more-information](../../../includes/proc-more-information.md)] [Сохранение содержимого источника с помощью веб-шаблонов](store-content-web-templates.md) Наша цель — создать простой шаблон с двумя колонками, использующий [набор веб-ссылок](../configure/manage-web-links.md) для навигации с левой стороны и с содержимым страницы справа. 
