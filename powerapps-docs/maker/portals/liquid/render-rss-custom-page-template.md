...
![Настройка шаблона страницы для веб-канала RSS](../media/page-template-rss-feed.png "Настройка шаблона страницы для RSS-канала")  
...
Пример RSS- ![канала]. пример RSS-(../media/rss-feed-example.png "канала")  
