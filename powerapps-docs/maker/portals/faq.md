...
Портал, [подготовленный с использованием плана надстройки портала](provision-portal-add-on.md), купленного ранее, приостанавливается по истечении срока действия. Этот период истечения срока действия составляет 30 дней для пробных порталов, в то время как он может варьироваться для дополнительного портала в производственной среде с приобретенной лицензией. Приостановленный пробный портал удаляется через 7 дней, в то время как период приостановки может изменяться для производственного портала. Дополнительные сведения см. в разделе [жизненный цикл портала](./admin/portal-lifecycle.md#considerations-for-add-on-portals) для дополнительных порталов.
...
[Порталы Power Apps](overview.md) теперь доступны полностью автономно внутри Power Apps. Вам больше не нужно приобретать лицензию для подготовки портала. Для доступа пользователя к порталу требуется лицензия в зависимости от типа персоны. Подробнее читайте в [вопросах и ответах по лицензированию порталов Power Apps](https://docs.microsoft.com/power-platform/admin/powerapps-flow-licensing-faq#can-you-share-more-details-regarding-the-new-power-apps-portals-licensing).
