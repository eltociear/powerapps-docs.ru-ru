...
Если вы продолжаете получать запрос на создание базы данных или ваши данные не совсем готовы, вы можете попробовать обновить домашнюю страницу PowerApps, прежде чем выбрать портал из пустой (предварительный просмотр) плитки.
