...
> [!div class=mx-imgBorder]
> ![Учетная запись хранения блога Azure](../media/azure-blob-storage.png "Учетная запись хранения блога Azure")
...
2. Перейдите к **действиям портала** > **Обновить конфигурацию ведения журнала диагностики**.
   ...
   > [!div class=mx-imgBorder]
   > ![Обновление конфигурации ведения журнала диагностики](../media/update-diagnostic-logging.png "Обновление конфигурации ведения журнала диагностики")
