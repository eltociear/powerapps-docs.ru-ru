...
## <a name="open-powerapps-portals-admin-center"></a>Открытие Центра администрирования порталов PowerApps.
...
1. Откройте центр администрирования порталов PowerApps и перейдите на вкладку **Сведения о портале**.
...
6. После добавления себя в качестве ответственного снова откройте страницу центра администрирования порталов PowerApps.