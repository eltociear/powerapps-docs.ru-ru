...
3. В **Связано** выберите **Разрешения сущности**.

4. Выберите **Добавить существующее разрешение сущности** для добавления существующего разрешения сущности в веб-роль. 

4. Найдите разрешение сущности или выберите **Создать разрешение сущности**, чтобы создать новую запись разрешения сущности.
...
Формы сущностей будут допускать только соответствующие разрешения для чтения, создания, записи и т. д., если это отношение существует при загрузке записи. [!INCLUDE[proc-more-information](../../../includes/proc-more-information.md)] [Определение форм сущности](entity-forms.md).  
