...
> - Повторяющиеся поля, набор параметров с выбором нескольких вариантов, настраиваемые элементы управления и бизнес-правила не поддерживаются в формах сущностей.
...
|Вложить файл|   Установите флажок, чтобы форма включала элемент управления отправкой файла в нижней части формы, позволяя прикрепить файл к записи. Вы должны выбрать **Включить разрешения сущностей** и назначьте разрешения "Создать", "Добавить" и "Добавить к" для сущности "Заметка", чтобы пользователь мог прикреплять файлы к форме. Дополнительные сведения: [Назначение разрешений сущности](assign-entity-permissions.md)<br>**Примечание**. Если у пользователя нет соответствующих разрешений на отправку файла или если не выбран параметр "Включить разрешения сущности", вариант отправки файла не будет отображаться в форме.|
