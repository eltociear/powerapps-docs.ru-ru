...
1.  Перейдите к целевой сущности, например **Продажи** > **Интересы**.
2.  Выберите требуемое представление в раскрывающемся заголовке представления.
3.  Выберите **Представление** на панели инструментов. Откроется окно "Представление".
...
4. Скопируйте значение **id** из URL-адреса окна представления.
...
5. Вставьте этот идентификатор в объявление Liquid-тега "chart" для параметра "viewid", например:
