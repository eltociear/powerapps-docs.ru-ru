...
- В Power apps значения валют экспортируются в Excel как числа. После завершения экспорта обратитесь к разделу справки Excel "Отображение чисел как денежной единицы", чтобы отформатировать данные как валюту.
