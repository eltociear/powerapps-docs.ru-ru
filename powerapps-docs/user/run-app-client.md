...
* **Все приложения**: Отображает все приложения, к которым у вас есть доступ, включая созданные вами приложения и приложения, к которым вам предоставили доступ другие пользователи.

* **Мои приложения**: Отображает приложения, которые были запущены по крайней мере один раз.

* **Примеры приложений**: Отображает примеры приложений от корпорации Майкрософт, демонстрирующие реальные сценарии приложений с фиктивными данными, которые помогут вам исследовать возможности проектирования.

* **Избранное**: Отображает приложения, которые были помечены, нажав кнопку с многоточием (...) на плитке приложения, а затем выбрав пункт **Избранное**. Чтобы удалить приложение из этого списка, нажмите многоточие (...) на плитке приложения и выберите пункт **Удалить из избранного**.
