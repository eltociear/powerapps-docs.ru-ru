...
---
Включив внедрение Power BI плиток и панелей мониторинга, когда пользователь внедряет Power BI плитку или панель мониторинга, маркер авторизации [!INCLUDE[pn_azure_active_directory](pn-azure-active-directory.md)] пользователя для Common Data Service используется для проверки подлинности в служба Power BI с неявным предоставлением, предоставляя простой " возможности единого входа для конечного пользователя.  
