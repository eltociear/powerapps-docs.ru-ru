...
-   Разработка схемы обучения применительно к конфигурации.  
 ...
 [Очередь службы хранилища Azure](https://azure.microsoft.com/en-us/services/storage/)  
 ...
 Схема обучения использует [!INCLUDE[pn_azure_blob_storage](pn-azure-blob-storage.md)] для хранения статического содержимого (клиентского кода [!INCLUDE[pn_JavaScript](pn-javascript.md)], изображений, CSS).  
  
 [Сеть доставки содержимого (CDN) Azure](https://azure.microsoft.com/en-us/services/cdn/)  
