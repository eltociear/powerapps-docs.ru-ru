---
title: Развертывание и настройка приложения для службы экстренной медицинской помощи | Документация Майкрософт
...
ms.locfileid: "80871656"
---
# <a name="deploy-and-configure-the-hospital-emergency-response-app"></a>Развертывание и настройка приложения для службы экстренной медицинской помощи
...
## <a name="demo-deploy-and-configure-the-hospital-emergency-response-app"></a>Демонстрация. Развертывание и настройка приложения для службы экстренной медицинской помощи
...
Основные данные также можно добавить в дальнейшем вручную. Дополнительные сведения: [Настройка основных данных в организации вручную и управление ими](#manually-configure-and-manage-master-data-for-your-organization)
...
Администраторы могут использовать приложение на основе модели в [Power Apps](https://make.powerapps.com) для создания основных данных и управления ими в организации. Эти данные необходимы для работы приложения для службы экстренной медицинской помощи.
...
Фильтры в верхней части отчета можно использовать для фильтрации данных для систем, регионов и медицинских учреждений. Вы также можете фильтровать местоположения для лечения COVID.

> [!div class="mx-imgBorder"]
> ![Фильтры в отчетах](media/report-filters.png)
...
- **COVID Patients** (Пациенты, зараженные COVID) — показывает общее число пациентов с COVID, число пациентов с положительным результатом анализов на наличие COVID-19 и число пациентов, находящихся под наблюдением. 
...
- **Nurse staffing management** (Управление младшим медицинским персоналом) — показывает количество пациентов в отделении интенсивной терапии, назначенных медсестер и соотношение медсестер к пациентам.  

- **Discharges** (Выписки) — показывает число пациентов, пребывающих на длительном лечении, ожидающих выписку, а также уже выписанных. 

- **Equipment** (Оборудование) — показывает общее количество аппаратов ИВЛ, количество используемых и доступных аппаратов ИВЛ. 

- **Supplies** (Снабжение) — показывает количество запасов в наличии по дням.

> [!NOTE]
> - При выборе значка сведений (i) в любой из областей сводки отображается соответствующая страница сведений для области. 
...
- "Total staff requested, number of patients (census), nurse to patient ratio" (Общее количество запрашиваемого персонала, количество пациентов (перепись), соотношение медсестер и пациентов);
- запасы в наличии по дням.

> [!div class="mx-imgBorder"]
> ![Системное представление](media/report-system-view.png)

#### <a name="location-details-page"></a>Страница Location Details (Сведения о местоположении) 

Чтобы детализировать отчет по расположению, щелкните **Location Details** (Сведения о местоположении) в правом верхнем углу. На странице **Location Details** (Сведения о местоположении) отображаются данные по расположению, например общее количество коек, число доступных и дополнительных коек, пациентов с COVID и т. д. 

> [!div class="mx-imgBorder"]
> ![Сведения о местоположении](media/report-location-details.png) 

#### <a name="covid-patient-details-page"></a>Страница COVID Patient Details (Сведения о пациентах с COVID) 

На странице **COVID Patient Details** (Сведения о пациентах с COVID) содержатся подробные сведения о пациентах с COVID, например количестве пациентов в каждом местоположении, состояние пациентов с течением времени, для которого показаны пиковые значения и уменьшение количества пациентов под наблюдением, а также число пациентов, пребывающих в больнице.
...
На странице **Bed Management** (Управление койками) представлена детализированная информация по местоположению, например об общем количестве доступных коек и процент заполненности.

> [!div class="mx-imgBorder"]
> ![Bed Management](media/report-bed-details.png) (Управление койками)

#### <a name="staff-details-page"></a>Страница Staff Details (Сведения о персонале)  

На странице **Staff Details** (Сведения о персонале) содержатся сведения о сотрудниках в местоположении, количество назначенных медсестер, общее число пациентов и количество пациентов с COVID. Здесь также отображается соотношение младшего медперсонала к пациентам, а также младшего медперсонала к пациентам в отделениях интенсивной терапии за определенный период времени.

> [!div class="mx-imgBorder"]
> ![Staff Details](media/report-staff-details.png) (Сведения о персонале)

#### <a name="equipment-details-page"></a>Страница Equipment Details (Сведения об оборудовании) 

На странице **Equipment Details** (Сведения об оборудовании) содержатся сведения об оборудовании в местоположении, общее количество используемых аппаратов ИВЛ в соотношении с количеством пациентов с COVID, а также сведения о других используемых единицах оборудования, таких как ремни, зарядные устройства и капюшоны.

> [!div class="mx-imgBorder"]
> ![Equipment Details](media/report-equipment-details.png) (Сведения об оборудовании)

#### <a name="discharge-details-page"></a>Страница Discharge Details (Сведения о выписках) 

На странице **Discharge Details** (Сведения о выписках) содержатся сведения о пациентах, пребывающих на долгосрочном лечении, мерах ограничения за период, а также об отличии числа фактических выписок от ожидаемых.

> [!div class="mx-imgBorder"]
> ![Equipment Details](media/report-discharge-details.png) (Сведения об оборудовании)

#### <a name="supplies-on-hand-details-page"></a>Страница Supplies on Hand Details (Сведения о запасах в наличии) 

Страница **Supplies on Hand Details** (Сведения о запасах в наличии) содержит подробную информацию о снабжении по местоположению. Здесь также содержатся данные о запасах в наличии на определенный период времени.
