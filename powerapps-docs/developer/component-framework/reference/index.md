---
title: Справочник по API платформы компонентов PowerApps | Документация Майкрософт
description: В этом разделе содержится справочник по API платформы компонентов PowerApps.
ms.date: 01/12/2018
...
|Имя|Описание|
|----|-----------|
|[Клиент](client.md)|[!INCLUDE [client-description](includes/client-description.md)]|
|[Столбец](column.md)|[!INCLUDE [column-description](includes/column-description.md)]|
...
|[Элемент управления](control.md)|[!INCLUDE [control-description](includes/control-description.md)]|
...
|[Форматирование](formatting.md)|[!INCLUDE [formatting-description](includes/formatting-description.md)]|
|[Mode](mode.md)|[!INCLUDE [mode-description](includes/mode-description.md)]|
|[Навигация](navigation.md)|[!INCLUDE [navigation-description](includes/navigation-description.md)]|
