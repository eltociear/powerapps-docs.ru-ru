---
title: Форматирование компонента API | Документация Майкрософт
description: ''
keywords: ''
ms.author: nabuthuk
author: Nkrb
...
ms.locfileid: "72340444"
---
# <a name="implementing-formatting-api-component"></a>Реализация компонента API форматирования

В этом примере компонента рассматриваются различные методы, доступные в API форматирования платформы компонента PowerApps. В этом примере создается ряд входных элементов, которые вызывают соответствующие методы API форматирования, соответствующие отображаемому значению.

> [!div class="mx-imgBorder"]
> ![Форматирование]компонента API(../media/formatting-api.png "API") форматирования
